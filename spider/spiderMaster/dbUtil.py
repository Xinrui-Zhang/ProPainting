...
# def addWordQuestion(question):
#     creator_id = 1
#     type = "w"
# def hasWord(content,lang):
#     t=''


# def addWord(content,pos,lang,meaning_raw,meaning_zh,pronounce_url,pronounce):
#     tag = ''


# def updateWord(content,pos,meaning_raw,meaning_zh,pronounce_url,pronounce):
#     tag = ''

...
Vue.prototype.$device.isDesktop = window.innerWidth > 576
Vue.prototype.$device.isMobile = window.innerWidth <= 576
Vue.prototype.$device.height = window.innerHeight
Vue.prototype.$device.platform = () => {
    let device = window.innerWidth < 576 ? 'mobile' : 'desktop'

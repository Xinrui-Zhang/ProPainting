package seu.se.practice2.propainting.config.db;
...
public class TKMyBatisSQLSessionConfigurer {
	...
	public SqlSessionFactory sqlSessionFactory(
		...
		// 配置实体类对象
		bean.setTypeAliasesPackage("seu.se.practice2.propainting.model.dao.entity");
...
//		configuration.setLogImpl(StdOutImpl.class);  // 显示 mysql 语句
	...
	public MapperScannerConfigurer mapperScannerConfigurer() {
		...
		mapperScannerConfigurer.setBasePackage(
			"seu.se.practice2.propainting.model.dao.mapper"
		);
